...
public class viewJantri extends AppCompatActivity {
    ...
    TextView total_jantri,logos_name,view_jantri_date_time;
    int total=0;
    int get;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_view_jantri);
        view_jantri_date_time=findViewById(R.id.view_jantri_date_time);
        RecyclerView.LayoutManager manager = new GridLayoutManager(viewJantri.this,5);
        ...
        RecyclerView.LayoutManager manager1 = new GridLayoutManager(viewJantri.this,5);
        ...
        RecyclerView.LayoutManager manager2 = new GridLayoutManager(viewJantri.this,5);
    ...
    private void add_number() {
        ...
        progressDialog.show();
        String url = "https://delhidiamond.online/index.php/get-user-bids";
...
*/      SharedPreferences sharedPreferences = getSharedPreferences(Config.SHARED_PREF_NAME, Context.MODE_PRIVATE);
        ...
        CustomRequest jsObjRequest = new CustomRequest(Request.Method.POST, url, params, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    viewJantri_Adapter attributes = new viewJantri_Adapter(mIconText,mIconText_amount, viewJantri.this);
                    ...
                    viewJantri_Adapter attributes1 = new viewJantri_Adapter(mIconText1,mIconText1_amount, viewJantri.this);
                    ...
                    viewJantri_Adapter attributes2 = new viewJantri_Adapter(mIconText2,mIconText2_amount, viewJantri.this);
                ...
                try {
                    String dateobj=response.getString("start_time");
                    String[] parts = dateobj.split(" ");
                    dateobj=parts[0];
                    view_jantri_date_time.setText(dateobj);
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK ) {
            Intent intent = new Intent(viewJantri.this, DelhiDiamond.class);
