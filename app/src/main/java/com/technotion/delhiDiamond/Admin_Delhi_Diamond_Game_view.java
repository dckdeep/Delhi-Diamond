...
import com.technotion.delhiDiamond.AllFragments.CoinsReport_delhi_diamond_game;
import com.technotion.delhiDiamond.AllFragments.ResultReport_delhi_diamond_game;
 ...
 */
public class Admin_Delhi_Diamond_Game_view extends AppCompatActivity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin__delhi__diamond__game_view);
        ...
        Admin_Delhi_Diamond_Game_view.ViewPagerAdapter viewPagerAdapter = new Admin_Delhi_Diamond_Game_view.ViewPagerAdapter(getSupportFragmentManager());
