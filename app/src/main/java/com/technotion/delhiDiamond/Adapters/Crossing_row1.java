...
public class Crossing_row1 extends RecyclerView.Adapter<Crossing_row1.viewHolder> {
    ...
    Context context;
    public Crossing_row1(   ArrayList<String> button_count, Context context) {
        ...
        holder.row2_tenth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(count==0) {
                    ...
                    if(i==9) {
                        Config.get_numbers_row1.add("0");

                    }else{
                       int x = i + 1;
                        String s = String.valueOf(x);
                        Config.get_numbers_row1.add(s);
                    ...
                    for(int a=0; a<Config.get_numbers_row1.size(); a++){
                        String s1 = String.valueOf(i+1);
                        String dlt = Config.get_numbers_row1.get(a);
                        if(s1.equals(dlt)){
                            Config.get_numbers_row1.remove(a);
