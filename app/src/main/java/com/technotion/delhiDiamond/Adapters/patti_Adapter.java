...
public class patti_Adapter  extends RecyclerView.Adapter<patti_Adapter.viewHolder> {
    ...
    Context context;
    public patti_Adapter(   ArrayList<String> mIconText,ArrayList<String> id,ArrayList<String> coins,ArrayList<String> Agent_id ,Context context) {
    ...
    @NonNull
    @Override
    public patti_Adapter.viewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View viewfull = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.activity_ajent_users,viewGroup,false);
        patti_Adapter.viewHolder v = new patti_Adapter.viewHolder(viewfull);
        return v;
    }

    @Override
    public void onBindViewHolder(@NonNull final patti_Adapter.viewHolder holder, final int i) {
      /*  Glide.with(context).asBitmap().load(mIcons.get(i)).into(viewHolder.imageView);
        ...
        if(Config.view_list_admin==2) {
            add_text.setText("Set Patti");
            holder.send_points.setText("Set Patti");
        }if(Config.view_list_admin==1){
            add_text.setText("Commission");
            holder.send_points.setText("Set Commission");
        }
...
*/
                        ...
                        params.put("agent_id", Agent_id.get(i));
                        params.put("patti_id", id.get(i));
                        params.put("patti", player_coins);
                       ...
                       /* String s = String.valueOf(response);
                        Toast.makeText(context, s, Toast.LENGTH_LONG).show();*/
                          /*  try {
                                ...
                                intent.putExtra("open_patti", Config.view_list_admin);
                                context.startActivity(intent);
                            }
                    ...
                    if(Config.view_list_admin==1) {
                        String url = "https://delhidiamond.online/index.php/add-agent-commision";
                        Map<String, String> params = new HashMap<String, String>();
                        SharedPreferences sharedPreferences = context.getSharedPreferences(Config.SHARED_PREF_NAME, Context.MODE_PRIVATE);
                        /*  String agent_id = sharedPreferences.getString(Config.AGENT_ID,"Not Available");*/
/*
                Toast.makeText(context,agent_id,Toast.LENGTH_LONG).show();
*/
                        String s = String.valueOf(Config.game_type_admin);
                        params.put("agent_id", Agent_id.get(i));
                        params.put("commision_id", id.get(i));
                        params.put("commision", player_coins);
                        params.put("game_type",s);
